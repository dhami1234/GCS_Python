...
python ../gui.py -rd -soho 'C2' -stereo 'COR2beacon' "2010-05-23 20:54" 'STA' 'SOHO' 'STB'
python ../gui.py -rd -soho 'C2' -stereo 'COR2beacon' "2010-05-23 21:24" 'STA' 'SOHO' 'STB'
...
python ../analyse_gcs_results.py 'CME_09_beacon.sh'